...
assert_contains "$ROOT/Containerfile" 'ARG KWIN_REF'
assert_contains "$ROOT/Containerfile" 'FROM ${KWIN_REF} AS kwin'
assert_contains "$ROOT/packages/Containerfile" 'FROM scratch AS out-kwin'
